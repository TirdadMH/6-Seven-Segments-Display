...
TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
  ...
  while (1)
  {
       on_seven_seg(6, 5, 4, 3, 2, 1); // for debug 
       on_seven_seg(i, j, k, l, v, m); // ersal addad be 7 seg ha
       if (PINB.0 == 0)
       {
           PORTD.0 = 1; // for debug
           if ((i == 9) && (j == 9) && (k == 9) && (l == 9) && (v == 9) && (m == 9))
           {
               on_seven_seg(i, j, k, l, v, m);
               continue;
           }
           on_seven_seg(i, j, k, l, v, m);
           delay_ms(165);
